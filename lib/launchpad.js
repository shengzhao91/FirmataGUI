...
launchpadObj.servoWrite = function(socket) {
    socket.on('servoWriteReq',function(data){
        console.log('Servo Pin'+data.pin+', '+data.degree);
        board.servoWrite(data.pin,data.degree);
    });
}
