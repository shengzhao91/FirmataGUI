...
LaunchPadServer.prototype.closeSerialPort = function(socket) {
    if (board) {
        socket.removeAllListeners("pinMode");
        socket.removeAllListeners("digitalWrite");
        socket.removeAllListeners("analogWrite");
        socket.removeAllListeners("I2CInitRequest");
        socket.removeAllListeners("I2CReadRequest");
        socket.removeAllListeners("I2CWriteRequest");
        socket.removeAllListeners("analogUpdateFreqReq");
...
module.exports = LaunchPadServer;
